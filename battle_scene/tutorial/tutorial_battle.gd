...
@onready var real_dice = Global.dummy_dice
@onready var tutorial_graphics = $TutorialGraphics
...
func _ready() -> void:
	...
	Global.dummy_dice = [Global.standard]
	_get_ui_elements()
...
func _setup_player() -> void:
	...
	var dice = dice_roller.get_dice_children()
	for die in dice:
		die.z_index = 6
	tutorial_graphics.modulate.a = 1
